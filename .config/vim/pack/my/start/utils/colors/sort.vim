...
let s:palette.comments = copy(s:palette.gray02)
let s:palette.numbers = copy(s:palette.green)
...
call s:hi('Normal', s:palette.gray13, s:palette.none, '')
set background=dark
...
call s:hi('LineNr', s:palette.gray04, s:palette.none, 'none')
...
call s:hi('VertSplit', s:palette.black, s:palette.black, 'none')
