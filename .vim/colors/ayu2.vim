...
hi ColorColumn  guifg=NONE    guibg=#151A1E gui=none ctermfg=0    ctermbg=none cterm=none
...
hi OverLength   guifg=#F07178 guibg=NONE    gui=none ctermfg=211  ctermbg=0    cterm=none
